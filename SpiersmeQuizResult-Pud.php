...
<html lang = "en">
    <head>
        <title>Puddle Fanpage Quiz - Result Puddle</title>
        <meta charset="utf-8">
    ...
    <body onload="grabSubtitle()">
        ...
        <div id="resultCatWrap">
            <div id="resultTextWrap">
                ...
                <p id="catNamePud">PUDDLE</p>
                <p>Soft of coat and mind. The most paradoxical cat, mystifying those around her.</p>
            </div>
            <img src="puddle_pic2.jpg" 
                id = "Pud_pic"
                alt="Pud on bed">
        </div>
    </body>

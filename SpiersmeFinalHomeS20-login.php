...
Pawprint: spiersme
Date: 04/19/2020
Final Project: Puddle Fanpage: Home, before login initiated
-->

<!DOCTYPE html>
<html lang = "en">
    <head>
        <title>Puddle Fanpage Home, before login initiated 2</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <!--Home link-->
        <a hidden href="SpiersmeFinalHomeS20-loginpassed.php" class="navTabs" id="navHome">HOME</a>
        
        <!--Quiz link-->
        <a hidden href="SpiersmeFinalQuizS20.php" class="navTabs" id="navQuiz">QUIZ</a> 
        
        <!--Gallery dropdown link-->
        <div class="dropdown">  
            <button hidden class="navTabs" id="navGallery">GALLERY  &or;</button>
        ...
        <!--Contact link-->
        <a hidden href="SpiersmeFinalContactS20.php" class="navTabs" id="navContact">CONTACT</a> 
        
        <!--Logout link-->
        <a hidden href="SpiersmeFinalHomeS20.php" class="navTabs" id="navLogout">LOGOUT</a> 
        ...
        <div id=rSideWrapper class="clear">
            ...
            <!-- Login section -->
            <form action="SpiersmeFinalLogin.php" id="loginSection" method="POST">
                <input type=hidden name="action" value="initiateLogin">
                ...
                <input type="submit" value="Submit" id="login" name="login"><br>
            </form>
            ...
            <div class="rSideSections">Add Puddle on Instagram!
                ...
                <a href="https://www.instagram.com/Puddle_About_House/" id="rSideContent">Username: pud_about_house</a>
            </div>

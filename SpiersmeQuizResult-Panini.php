...
<html lang = "en">
    <head>
        <title>Puddle Fanpage Quiz - Result Panini</title>
        <meta charset="utf-8">
    ...
    <body onload="grabSubtitle()">
        ...
        <div id="resultCatWrap">
            <div id="resultTextWrap">
                ...
                <p id="catNamePud">PANINI</p>
                <p>Adventerous, troublesome, and cuddly. The youngest and most wild cat.</p>
            </div>
            <img src="Panini_pic.jpg" 
                id = "Pud_pic"
                alt="Panini lying against wall">
        </div>
    </body>
</html>

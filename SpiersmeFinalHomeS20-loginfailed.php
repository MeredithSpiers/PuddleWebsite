...
Pawprint: spiersme
Date: 04/19/2020
Final Project: Pud Fanpage: Home, after failed login attempt
-->

<!DOCTYPE html>
<html lang = "en">
    <head>
        <title>Pud Fanpage Home, after failed login attempt</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <!--Logout link-->
        <a hidden href="SpiersmeFinalHomeS20-login.php" class="navTabs" id="navLogout">LOGOUT</a> 
        ...
        <div id=rSideWrapper class="clear">
            ...
            <form action="SpiersmeFinalLogin.php" id="loginSection" method="POST">
                ...
                <input type="submit" value="Submit" id="login" name="login"><br><br>
                <div id="loginFail">Username or password was incorrect. Please try again.</div>
            </form>

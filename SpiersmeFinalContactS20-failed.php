...
Pawprint: spiersme
Date: 05/08/2020
Final Project: Puddle Fanpage: Contact: Message failed to send
-->
...
<html lang = "en">
    <head>
        <title>Puddle Fanpage Contact: Message failed</title>
        <meta charset="utf-8">
        ...
        <h1><span>Contact Puddle</span></h1>
            ...
            <div id=formWrapper class="clear">
                ...
                <form action="Spiersme_contact.php" method="post">
                    ...
                    <div id="messageFailed">Error: Please make sure you have entered an email, subject, and message.</div>
                </form>
            </div>

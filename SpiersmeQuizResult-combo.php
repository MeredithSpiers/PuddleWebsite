...
<html lang = "en">
    <head>
        <title>Puddle Fanpage Quiz - Result Combination</title>
        <meta charset="utf-8">
    ...
    <body onload="grabSubtitle()">
        ...
        <div id="resultCatWrap">
            <div id="resultTextWrap">
                ...
                <p id="catNamePud">COMBO</p>
                <p>Congratulations! You are a perfect combination of each cat.</p>
            </div>
            <img src="catCombo_pic.jpg" 
                id = "Pud_pic"
                alt="All three cats looking out door">
        </div>
